Public Class JobsDeclined
    ...
    Private Sub JobsDeclined_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MySQLC.Connect()
        MySQLC.GetJobsDeclined()
        DGVProperties()
